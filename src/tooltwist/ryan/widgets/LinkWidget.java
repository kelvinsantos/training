package tooltwist.ryan.widgets;
...
//import tooltwist.ryan.productionHelpers.LinkProductionHelper;
...
//TODO: Uncomment this as required
		...
		if (mode == GenerationMode.DESIGN)
		{
			...
			CodeInserter[] arr = {
				...
				new StylesheetCodeInserter(generator, instance, "link_cssHeader.css"),
			};
...
//				new StylesheetLinkInserter(cssUrl),
				...
				new JavascriptCodeInserter(generator, instance, "link_jsHeader.js"),
		...
		else if (mode == GenerationMode.PRODUCTION || generator.getMode() == GenerationMode.CONTROLLER)
		{
			...
			CodeInserter[] arr = {
//				// Link to an external Javascript file
				new JavascriptLinkInserter("/ttsvr/ryan/script/js/temp.js"),
